...
Latest: **93 tests.** All pass where a headless-runnable `claude` is on PATH; otherwise the one real
`claude --plugin-dir` load test skips, leaving **92 passed, 1 skipped**.
